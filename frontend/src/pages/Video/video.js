  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Fetch video — this also increments view count on backend
    ...
    <div className="video-page">
      ...
      <div className="videopost-section">
        ...
        <div className="video_views_row">
          ...
          <span className="video_views_count">
            {formatViews(videoData.views)} views
          </span>
          <span className="video_views_date">
            • {new Date(videoData.createdAt).toDateString()}
          </span>
        </div>
        ...
        <div className="video_info_row">
          ...
          <div className="like_section">
            <div
              ...
              style={{ cursor: "pointer", color: liked ? "#3ea6ff" : "white", display: "flex", alignItems: "center", gap: 5 }}
            >
              <ThumbUpIcon /><span>{videoData.likes?.length || 0}</span>
            </div>
            <div
              onClick={() => handleReaction("dislike")}
              style={{ cursor: "pointer", color: disliked ? "red" : "white", marginLeft: 15 }}
            >
              <ThumbDownIcon />
            </div>
            <div
              onClick={handleWatchLater}
              style={{ cursor: "pointer", marginLeft: 15, display: "flex", alignItems: "center", gap: 5 }}
            >
